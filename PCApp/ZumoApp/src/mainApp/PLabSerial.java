...
/**
 * @author Dag Svanaes, IDI, NTNU. PLabSerial is a class for simplifying
 *         communication with serial ports. It was made for the PLab course at
 *         IDI-NTNU to ease communication with serial Bluetooth devices, such as
 *         HC-06. It build on a library from com.fazecast.jSerialComm.
 *
 *         Methods: public String[] getPortNames() public boolean
 *         openPort(String portName) public boolean openPLabPort() public String
 *         getOpenPortName() public void closePort() public void
 *         sendMessage(String s) public void sendMessage(String s, int i) public
 *         void addListener(Object receiverObject, String methodName) Requires
 *         that the receiverObject class implements a callback method: public
 *         void methodName(String message, int value)
 *
 */
